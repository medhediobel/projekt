 ...
 */
final class Version20210108162248 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE verfahren ADD lat DOUBLE PRECISION NOT NULL, ADD lng DOUBLE PRECISION NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE verfahren DROP lat, DROP lng');
        $this->addSql('ALTER TABLE vertreta CHANGE behoerde_id behoerde_id INT DEFAULT NULL');
    }
}
